package org.sjtu.dclab.myhadoop.hdfs;
...
/**
 * HDFS 操作类，包含文件列表ls, 文件创建,目录创建，文件删除，文件重命名 功能
 */
public class HdfsDAO {

    //HDFS服务器位置
    private static final String HDFS = "hdfs://202.120.40.111:9000/";
    ...
    public static void main(String[] args) throws IOException {
        ...
        hdfs.ls("/");   //list all files under directory '/'
